package org.sso.auth.jwt.server.config.role.service.impl;
...
import org.sso.auth.jwt.server.config.role.entity.SysPermission;
import org.sso.auth.jwt.server.config.role.entity.SysRolePermission;
import org.sso.auth.jwt.server.config.role.entity.SysUserRole;
import org.sso.auth.jwt.server.config.role.mapper.SysPermissionMapper;
import org.sso.auth.jwt.server.config.role.mapper.SysRolePermissionMapper;
import org.sso.auth.jwt.server.config.role.mapper.SysUserRoleMapper;
import org.sso.auth.jwt.server.config.role.service.ISysPermissionService;
