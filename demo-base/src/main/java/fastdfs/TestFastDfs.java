 ...
 * 
 * 
 * @author yuezh2   2018年9月11日 下午8:58:48
 *
 */
public class TestFastDfs {
     
    public String conf_filename = "D://workspace//git//yzh-learn//demo-base//src//main//resources//fastdfs//fdfs_client.conf"; 
     
    public String local_filename = "D:\\redis.xml";
...
//          NameValuePair nvp = new NameValuePair("age", "18"); 
    ...
    public void testDownload() {
        try {
            ...
            StorageClient storageClient = new StorageClient(trackerServer, storageServer); 
            byte[] b = storageClient.download_file("group1", "M00/00/00/CmPNEVuXvIKAYaONAAABOs1Yz4A312.png"); 
