package org.demo.netty.im.simple.v4.im.session;
...
import org.demo.netty.im.fake.session.LocalTransportStore;
...
public class LocalWaiterSession implements WaiterSession{
	...
	public void bindRoute() {
		OCIMServerV4.getInst().getRoutingTable().registerLocalWaiterSession(this);
	}
