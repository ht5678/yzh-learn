package org.demo.netty.dispatcher.room;
...
import org.demo.netty.dispatcher.cache.WaiterCache;
import org.demo.netty.dispatcher.cache.WaiterServiceCache;
import org.demo.netty.dispatcher.cache.pojo.ConciseWaiter;
...
//		WaiterMonitorProvider.getInst().waiterEnterService(waiter, waiter.getStatus());
	 ...
	 */
	@Override
	public synchronized void logout(String teamCode, String waiterCode) {
...
//			WaiterMonitorProvider.getInst().updateStatus(waiter, waiter.getStatus(), "4");
	 ...
	 */
	@Override
	public Waiter acquire(String teamCode, String waiterCode) {
	 ...
	 */
	@Override
	public Waiter acquire(String teamCode) {
		Waiter waiter;
	 ...
	 */
	@Override
	public Waiter directAcquire(String teamCode, String waiterCode) {
	...
	@Override
	public Waiter getWaiter(String teamCode, String waiterCode) {
		return waiterCache.get(teamCode, waiterCode);
	}

	@Override
	public void release(String teamCode, String waiterCode) {
	...
	public boolean tryTransferByWaiter(TransferWaiter transferWaiter){
		String teamCode = transferWaiter.getTmc();
	...
	@Override
	public boolean changeStatus(String teamCode, String waiterCode, String status) {
...
//		WaiterMonitorProvider.getInst().updateStatus(waiter, beforeStatus, status);
	 ...
	 * @param teamCode
	 */
	private void registerReleaseEvent(String waiterCode, String tenantCode, String teamCode) {
