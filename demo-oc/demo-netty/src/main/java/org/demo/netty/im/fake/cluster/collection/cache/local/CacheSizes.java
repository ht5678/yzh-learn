package org.demo.netty.im.fake.cluster.collection.cache.local;
...
import org.demo.netty.im.fake.cluster.collection.cache.Cacheable;
import org.demo.netty.im.fake.exception.CannotCalculateSizeException;

/**
 * 计算缓存大小(大约占用内存空间) , 单位为字节
 * @author yuezh2
 * @date	  2022年3月23日 下午10:36:21
 */
